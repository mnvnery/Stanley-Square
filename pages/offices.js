    ...
    return (  
        ...
        <div className='bg-tpink text-black px-8 md:px-10 py-10'>
            ...
            <div className='md:grid grid-cols-2 mt-10 md:mt-16'>
                <div dangerouslySetInnerHTML={{__html: data.largeParagraph}} className='text-4xl mb-10 md:mb-0 md:text-5xl md:w-3/4'/>
                <div dangerouslySetInnerHTML={{__html: data.smallerParagraph}} className='text-2xl paragraph ml-6 md:ml-0'/>
            </div>
            <div className='grid md:grid-cols-2 mt-10 mb-16'>
                <div>
                    ...
                    <div dangerouslySetInnerHTML={{__html: data.pullOut}} className='md:w-2/3 md:leading-tight py-20 text-5xl md:text-6xl'/>
                    <div className='bg-[#39324C] text-tpink border border-[#39324C] hover:text-[#39324C] hover:bg-transparent inline-block px-5 rounded-full text-2xl md:text-3xl'>SIGN UP FOR INFORMATION</div>
                </div>
            ...
            <div className='grid md:grid-cols-3 gap-8 text-xl md:text-lg'>
                {data.features.map((f, i) => (
                    <div key={i}>
                        <div className='relative h-[40vh] w-full mb-5'>
