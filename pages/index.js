  ...
  return (
    <>
      ...
      <div className='my-12 mx-8 flex md:my-20 xxl:m-32'>
        <div className='uppercase text-3xl md:text-8xl w-4/5 leading-none md:leading-[0.8] xxl:text-9xl'>
        <StructuredText data={data.heroIntro.value}/>
        </div>
        <div className='relative h-auto w-16 xxl:w-20'>
      ...
      <SoftMotion>
        <div className='relative w-4/5  mx-auto text-center md:w-3/5'>
          ...
          <div className='absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-2xl text-black uppercase pb-1 w-2/4 pt-3 md:pt-10 md:pb-4 md:text-5xl xxl:text-7xl'>About <BorderMotion /></div>
        </div>
                ...
                <div className='flip-card h-[35vh] md:h-[65vh] w-full'>
                  <div className='flip-card-inner'>
                    ...
                    <div className={`flip-card-back bg-${color(sector.title)} text-black rounded-2xl flex flex-col justify-end p-4 xxl:p-10`}>
                      <div dangerouslySetInnerHTML={{__html: sector.intro}} className='text-4xl xxl:text-6xl'/>
        ...
        <div className='bg-tbeige text-black p-8 md:p-10 xxl:px-32 xxl:py-20'>
            <LeftMotion>
              <div dangerouslySetInnerHTML={{__html: data.introParagraph}} className='text-2xl xxl:text-6xl w-5/6 md:text-3xl md:w-3/6 xxl:w-[55%]'/>
