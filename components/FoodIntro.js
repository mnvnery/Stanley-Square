...
const FoodIntro = ({image1, text1, image2, text2, pullOutQuote, quoteImage, title }) => {
    return (
        ...
        <div className={`bg-${color(title)} text-black pt-10 pb-16 relative z-[1]`}>
            ...
            <RightMotion>
            <div className='flex flex-col-reverse pt-10 px-8 md:px-10 text-2xl xxl:text-5xl gap-8 md:gap-14 md:pt-20 md:grid grid-cols-[0.5fr_1fr] items-center'>
                <div dangerouslySetInnerHTML={{__html: pullOutQuote }} className='paragraph md:mr-14 sale-about uppercase md:text-6xl xxl:text-8xl'/>
                <div className='relative w-100 h-[45vh] md:h-[60vh]'>
